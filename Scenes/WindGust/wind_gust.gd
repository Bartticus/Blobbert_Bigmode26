# Mostly stolen with(out) permission from https://www.youtube.com/watch?v=0HCzL5ealtI and https://github.com/haruotsa/godot_wind_gust
...
@export var timer_amount: float = 2.0
...
func _on_offset_timer_timeout() -> void:
	init_path_followers()
	repeat_timer.start(timer_amount)
